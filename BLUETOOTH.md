...
```sh
# Check Netgraph nodes
sudo ngctl list

# You should see a "ubt0" node (Type: ubt)
# Example output:
#   Name: ubt0    Type: ubt    ID: 00000042   Num hooks: 0

# Read HCI BD address (replace ubt0hci with actual HCI node)
